...
<h1>
 BEAUTY
		 ...
		 <br>
  <div class="create">
   <button type="button10" width: 40px; class="btn btn-outline-dark"> HOME / DIY´S / <span style="font-weight:900">BEAUTY</span></button>
...
</svg><span style="font-weight:900">&nbsp;BEAUTY</span></button>
...
<div class="card" style="width: 18rem;">
	<img src="assets/images/handsoap.jpg"  class="card-img-top" alt="green">
  <div class="card-body">
    <p class="card-text">HOMEMADE HANDSOAP</p>
        <p class="card-under">&nbsp;&nbsp;MADE BY: Jennifer Sandsjö&nbsp;&nbsp;</p>
  </div>
</div>
			
<div class="card" style="width: 18rem;">
	<img src="assets/images/oil.jpg"  class="card-img-top" alt="green">
  <div class="card-body">
    <p class="card-text">LAVENDEL OIL</p>
            <p class="card-under">&nbsp;&nbsp;MADE BY: Jennifer Sandsjö&nbsp;&nbsp;</p>
  </div>
</div>
			
<div class="card" style="width: 18rem;">
	<img src="assets/images/tea.jpg"  class="card-img-top" alt="green">
  <div class="card-body">
    <p class="card-text">HOMEMADE HERBAL TEA</p>
                <p class="card-under">&nbsp;&nbsp;MADE BY: Jennifer Sandsjö&nbsp;&nbsp;</p>
  </div>
</div>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <p class="card-text">LAVENDER and VANILLA SOAP</p>
                                    <p class="card-under">&nbsp;&nbsp;MADE BY: Jennifer Sandsjö&nbsp;&nbsp;</p>
  </div>
</div>
    </div>
...
<div class="card" style="width: 18rem;">
	<img src="assets/images/handsoap.jpg"  class="card-img-top" alt="green">
  <div class="card-body">
    <p class="card-text">HANDSOAD</p>
                        <p class="card-under">&nbsp;&nbsp;MADE BY: Linnea &nbsp;&nbsp;</p>
  </div>
</div>
			
<div class="card" style="width: 18rem;">
	<img src="assets/images/grapescrub.jpg"  class="card-img-top" alt="green">
  <div class="card-body">
    <p class="card-text">GRAPEFRUIT SCRUB</p>
                            <p class="card-under">&nbsp;&nbsp;MADE BY: Kajsa-Clara &nbsp;&nbsp;</p>
  </div>
</div>
			
<div class="card" style="width: 18rem;">
	<img src="assets/images/lotion.jpg"  class="card-img-top" alt="green">
  <div class="card-body">
    <p class="card-text">HOMEMADE BODYLOTION</p>
                                <p class="card-under">&nbsp;&nbsp;MADE BY: Jasmine&nbsp;&nbsp;</p>
  </div>
</div>
			
<div class="card" style="width: 18rem;">
	<img src="assets/images/kaffe.jpg"  class="card-img-top" alt="green">
  <div class="card-body">
    <p class="card-text">COFFEE SCRUB</p>
                                    <p class="card-under">&nbsp;&nbsp;MADE BY: Jennifer Sandsjö&nbsp;&nbsp;</p>
  </div>
</div>
    </div>
